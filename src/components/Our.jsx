...
const Our = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col md:flex-row items-center justify-center p-8 pt-[5rem] md:pt-[8rem] pb-[8rem] bg-gray-100">
      <div
        ref={missionRef}
        className="w-full md:w-1/2 flex flex-col items-center justify-center text-center md:text-left px-4 mb-12 md:mb-0"
      >
      ...
      <div
        ref={visionRef}
        className="w-full md:w-1/2 flex flex-col items-center justify-center text-center md:text-left px-4"
      >
        <img src={assets.telescope} alt="Vision" className="w-1/4 h-auto mb-4" />
